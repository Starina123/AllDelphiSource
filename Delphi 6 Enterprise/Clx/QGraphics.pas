...
const
  CopyModeToRasterOp: array[TCopyMode] of RasterOp = (
    ...
    {cmMergeCopy}   RasterOp_NotXorROP,   {cmMergePaint} RasterOp_NotXorROP,
    {cmNotSrcCopy}  RasterOp_NotCopyROP,  {cmNotSrcErase}RasterOp_NotEraseROP,
    {cmPatCopy}     RasterOp_NopROP,      {cmPatInvert}  RasterOp_NopROP,
    {cmPatPaint}    RasterOp_NopROP,      {cmSrcAnd}     RasterOp_AndROP,
    {cmSrcCopy}     RasterOp_CopyROP,     {cmSrcErase}   RasterOp_NopROP,
    {cmSrcInvert}   RasterOp_NotCopyROP,  {cmSrcPaint}   RasterOp_NopROP,
...
const
  ColorGroupMap: array[TColorGroup] of QPaletteColorGroup =
    (QPaletteColorGroup_Active, QPaletteColorGroup_Disabled, QPaletteColorGroup_Inactive);
...
begin
  ...
  try
    Owned := True;
    SetBrush(Group, Role, GetColor(Group, Role), Bitmap.Handle);
  finally
    EndUpdate;
  end;
end;
