...
uses
  ...
  StdCtrls, ActiveX, ComObj, ComCtrls, XMLDOM;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if Childs.item[I].nodeName = Tag then
          begin
...
begin
  ...
  try
    ...
    IStart := 0;
    if Node.nodeName = Tags.Strings[0] then
      IStart := 1;
...
begin
  ...
  begin
    ...
    try
      IStart := 0;
      if Node.nodeName = Tags.Strings[0] then //sync tag with node..special case
        IStart := 1;
