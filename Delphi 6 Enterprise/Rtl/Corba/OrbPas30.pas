...
uses Windows, Variants, VarUtils;
...
type
  ...
  ObjectProxy = interface (ISkeleton)
    ...
    function is_equivalent(other_object: ORBPAS30.ObjectProxy): ByteBool; stdcall;
    function is_persistent: ByteBool; stdcall;
    function object_name: PChar; stdcall;
    function repository_ID: PChar; stdcall;
    procedure prepare_reply(priv_data: Pointer; out outbuf: MarshalOutBufferProxy); stdcall;
    function get_bind_options: PBindOptions; stdcall;
    procedure set_bind_options(opt: PBindOptions); stdcall;
    procedure set_principal(bytes: Pointer; len : CorbaULong); stdcall;
  end;
  ...
  ISkeletonObject = interface
    ...
    procedure GetImplementation(out Impl: IUnknown); stdcall;
    function Execute(Operation: PChar; const Strm: MarshalInBufferProxy;
  ...
  ORBProxy = interface
    ...
    function DispatchStruct(Value: PCorbaAny; CallDesc: PCallDesc; Params: Pointer;
