...
type
  ...
  protected
    ...
    function Execute(Operation: PChar; const Strm: MarshalInBufferProxy): CorbaBoolean; stdcall;
...
function TCORBAObject.Execute(Operation: PChar; const Strm: MarshalInBufferProxy): CorbaBoolean;
type
...
var
  Proxy: ORBPAS40.MarshalOutBufferProxy;
begin
  (FProxy as ObjectProxy).GetReplyBuffer(Proxy);
...
var
  Proxy: ORBPAS40.MarshalOutBufferProxy;
begin
  (FProxy as ObjectProxy).GetExceptionReplyBuffer(Proxy);
  Outbuf := TOutputStream.Create(Proxy);
end;
