...
uses
  Classes, Variants, DSDesign, MConnect, MidasCon, CorbaCon, DBClient, Provider,
  ActiveX, ComObj, ShlObj, FldLinks, DBReg, DBConsts, DesignIntf, DesignEditors,
  Windows, Forms, SysUtils, DsnDBCst, MidConst, DataBkr, SConnect, MtsRdm, 
  CorbaRdm, ObjBrkr, Dialogs, Controls, DB, DMForm, TreeIntf, DsnDb, LMidReg;
  (*CustomModuleEditors, DMDesigner,
...
begin
  ...
  begin
    ...
    GroupDescendentsWith(TCorbaConnection, Controls.TControl);
    ...
    RegisterCustomModule(TCorbaDataModule, TDataModuleCustomModule);//TDataModuleDesignerCustomModule);
