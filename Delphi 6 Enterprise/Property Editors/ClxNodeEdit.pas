...
uses
  ...
  DesignIntf, DesignEditors, DsnConst, LibHelp, Consts, QStdCtrls, QComCtrls;
...
begin
{$IFDEF LINUX}
  if GetCurrentThreadID <> GetWineThreadID then
    HaveWineCallMeBack(InvokeEdit)
  else
  begin
{$ENDIF}
