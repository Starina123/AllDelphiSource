...
// ===== Interface declarations =====
  ...
  CALayer = interface(NSObject)
    ...
    procedure insertSublayer(layer: CALayer; idx: UInt32); cdecl; overload;
    ...
    procedure setContentsScale(contentsScale: Single); cdecl;
    function contentsScale: Single; cdecl;
    ...
    procedure setRasterizationScale(rasterizationScale: Single); cdecl;
    function rasterizationScale: Single; cdecl;
    ...
    procedure addAnimation(anim: CAAnimation; key: NSString); cdecl;
