...
function kCVPixelBufferMemoryAllocatorKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferMemoryAllocatorKey')^);
end;

function kCVPixelBufferWidthKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferWidthKey')^);
end;

function kCVPixelBufferHeightKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferHeightKey')^);
end;

function kCVPixelBufferExtendedPixelsLeftKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferExtendedPixelsLeftKey')^);
end;

function kCVPixelBufferExtendedPixelsTopKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferExtendedPixelsTopKey')^);
end;

function kCVPixelBufferExtendedPixelsRightKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferExtendedPixelsRightKey')^);
end;

function kCVPixelBufferExtendedPixelsBottomKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferExtendedPixelsBottomKey')^);
end;

function kCVPixelBufferBytesPerRowAlignmentKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferBytesPerRowAlignmentKey')^);
end;
...
function kCVPixelBufferOpenGLCompatibilityKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferOpenGLCompatibilityKey')^);
end;

function kCVPixelBufferPlaneAlignmentKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferPlaneAlignmentKey')^);
end;

function kCVPixelBufferIOSurfacePropertiesKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferIOSurfacePropertiesKey')^);
end;

function kCVPixelBufferIOSurfaceOpenGLTextureCompatibilityKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferIOSurfaceOpenGLTextureCompatibilityKey')^);
end;

function kCVPixelBufferIOSurfaceOpenGLFBOCompatibilityKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferIOSurfaceOpenGLFBOCompatibilityKey')^);
end;

function kCVPixelBufferIOSurfaceCoreAnimationCompatibilityKey: CFStringRef;
begin
  Result := CFStringRef(CocoaPointerConst(libCoreVideo, 'kCVPixelBufferIOSurfaceCoreAnimationCompatibilityKey')^);
end;
