...
{ TNotificationCenterCocoa }
  ...
  private
    ...
    FNotificationCenterDelegate: NSUserNotificationCenterDelegate;
...
procedure TNotificationCenterCocoa.DoCreateOrUpdateChannel(const AChannel: TChannel);
begin
  // Relevant only for Android
end;

procedure TNotificationCenterCocoa.DoDeleteChannel(const AChannelId: string);
begin
  // Relevant only for Android
end;
...
begin
  ...
  FNotificationCenterDelegate := nil;  
  inherited Destroy;
end;
...
procedure TNotificationCenterCocoa.DoGetAllChannels(const AChannels: TChannels);
begin
  // Relevant only for Android
end;
