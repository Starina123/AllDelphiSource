...
type
  ...
  {
  // Used Types:  Windows.UI.Text.FormatEffect
  // Used Types:  Windows.UI.Color
  // Used Types:  Windows.UI.Text.FontStretch
  // Used Types:  Windows.UI.Text.FontStyle
  // Used Types:  Single
  // Used Types:  String
  // Used Types:  Windows.UI.Text.LinkType
  // Used Types:  Windows.UI.Text.TextScript
  // Used Types:  Windows.UI.Text.UnderlineType
  // Used Types:  Int32
  // Used Types:  Windows.UI.Text.ITextCharacterFormat
  // Used Types:  Boolean
  }
  // Windows.UI.Text.ITextCharacterFormat
  ...
  {
  // Used Types:  Windows.UI.Text.ParagraphAlignment
  // Used Types:  Single
  // Used Types:  Windows.UI.Text.FormatEffect
  // Used Types:  Windows.UI.Text.LineSpacingRule
  // Used Types:  Windows.UI.Text.MarkerAlignment
  // Used Types:  Int32
  // Used Types:  Windows.UI.Text.MarkerStyle
  // Used Types:  Windows.UI.Text.MarkerType
  // Used Types:  Windows.UI.Text.ParagraphStyle
  // Used Types:  Windows.UI.Text.TabAlignment
  // Used Types:  Windows.UI.Text.TabLeader
  // Used Types:  Windows.UI.Text.ITextParagraphFormat
  // Used Types:  Boolean
  }
  // Windows.UI.Text.ITextParagraphFormat
  ...
  // Used Types:  Char
  // Used Types:  Windows.UI.Text.ITextCharacterFormat
  // Used Types:  Windows.UI.Text.ITextRange
  // Used Types:  Int32
  // Used Types:  Windows.UI.Text.RangeGravity
  // Used Types:  String
  // Used Types:  Windows.UI.Text.ITextParagraphFormat
  // Used Types:  Boolean
  // Used Types:  Windows.UI.Text.LetterCase
  // Used Types:  Windows.UI.Text.TextRangeUnit
  // Used Types:  Windows.UI.Text.FindOptions
  // Used Types:  UInt32
  // Used Types:  Windows.UI.Text.HorizontalCharacterAlignment
  // Used Types:  Windows.UI.Text.VerticalCharacterAlignment
  // Used Types:  Windows.UI.Text.PointOptions
  // Used Types:  Windows.Foundation.Point
  // Used Types:  Windows.Foundation.Rect
  // Used Types:  Windows.UI.Text.TextGetOptions
  // Used Types:  Windows.Storage.Streams.IRandomAccessStream
  // Used Types:  Windows.UI.Text.TextSetOptions
  }
  // Windows.UI.Text.ITextRange
  ...
  {
  // Used Types:  Windows.UI.Text.SelectionOptions
  // Used Types:  Windows.UI.Text.SelectionType
  // Used Types:  Int32
  // Used Types:  Windows.UI.Text.TextRangeUnit
  // Used Types:  Boolean
  // Used Types:  String
