...
// ===== Interface declarations =====
  ...
  JFontRequestClass = interface(JObjectClass)
    ...
    {class} function init(providerAuthority: JString; providerPackage: JString; query: JString; certificates: TJavaObjectArray<JList>): JFontRequest; cdecl; overload;
  end;

  [JavaSignature('android/provider/FontRequest')]
  JFontRequest = interface(JObject)
    ['{9F5102E4-89D6-4F06-8339-1EEB590388B6}']
    function getCertificates: TJavaObjectArray<JList>; cdecl;
