...
{$IFNDEF ANDROID}
  ...
  JJobIntentService = interface end;
...
{$ENDIF ANDROID}
  ...
  private
    ...
    FJavaJobIntentService: JJobIntentService;
  ...
  public
    ...
    property JavaIntentService: JJobIntentService read FJavaJobIntentService;
...
begin
  ...
  if FIntentService <> nil then
  begin
    FIntentService.FJavaJobIntentService := {$IFDEF ANDROID}TJJobIntentService.Wrap(AJavaService){$ELSE}nil{$ENDIF ANDROID};
