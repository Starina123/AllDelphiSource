...
type
  ...
  private
    ...
    class procedure Wrap(P: Pointer; ITypeInfo: PTypeInfo; var JNIClassID: Pointer; var ATable: TJavaVTable; var Resp);
    class procedure WrapInstance(const I: IJavaInstance; ITypeInfo: PTypeInfo; var JNIClassID: Pointer; var ATable: TJavaVTable; var Resp);
    class procedure Alloc(var ClsID: Pointer; ITypeInfo: PTypeInfo; var AVTable: TJavaVtable; var Resp); static;
    class function GetClsID(var AClsID: Pointer;LTypeInfo: PTypeInfo): Pointer; static;
...
class function TBridgeHelper.GetClsID(var AClsID: Pointer;LTypeInfo: PTypeInfo): Pointer;
var
  Context: TRttiContext;
  ClassType: TRttiType;
  Attrs: TArray<TCustomAttribute>;
...
class procedure TBridgeHelper.Wrap(P: Pointer; ITypeInfo: PTypeInfo; var JNIClassID: Pointer; var ATable: TJavaVTable; var Resp);
var
  Obj: TJavaImport;
begin
  if P = nil then
...
begin
  TBridgeHelper.Wrap(AJNIObjectID, TypeInfo(T), FJNIClassID, FInstanceVTable, Result)
end;

class procedure TBridgeHelper.WrapInstance(const I: IJavaInstance; ITypeInfo: PTypeInfo; var JNIClassID: Pointer; var ATable: TJavaVTable; var Resp);
begin
...
begin
  TBridgeHelper.WrapInstance(AInstance, TypeInfo(T), FJNIClassID, FInstanceVTable, Result);
end;
