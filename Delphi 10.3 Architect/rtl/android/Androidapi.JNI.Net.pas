...
// ===== Interface declarations =====
  ...
  JDiscoverySessionCallback = interface(JObject)
    ...
    procedure onServiceDiscovered(peerHandle: JPeerHandle; serviceSpecificInfo: TJavaArray<Byte>; matchFilter: TJavaObjectArray<JList>); cdecl;
  ...
  JPublishConfig_Builder = interface(JObject)
    ...
    function setMatchFilter(matchFilter: TJavaObjectArray<JList>): JPublishConfig_Builder; cdecl;
  ...
  JSubscribeConfig_Builder = interface(JObject)
    ...
    function setMatchFilter(matchFilter: TJavaObjectArray<JList>): JSubscribeConfig_Builder; cdecl;
