...
function TNetHTTPClientHelper.GetPreemptiveAuthentication: Boolean;
begin
  Result := FHttpClient.PreemptiveAuthentication;
end;

procedure TNetHTTPClientHelper.SetPreemptiveAuthentication(const AValue: Boolean);
begin
  FHttpClient.PreemptiveAuthentication := AValue;
end;

function TNetHTTPClientHelper.GetSecureFailureReasons: THTTPSecureFailureReasons;
begin
  Result := FHttpClient.SecureFailureReasons;
end;

function TNetHTTPClientHelper.GetAutomaticDecompression: THTTPCompressionMethods;
begin
  Result := FHttpClient.AutomaticDecompression;
end;

procedure TNetHTTPClientHelper.SetAutomaticDecompression(const AValue: THTTPCompressionMethods);
begin
  FHttpClient.AutomaticDecompression := AValue;
end;

function TNetHTTPClientHelper.GetUseDefaultCredentials: Boolean;
begin
  Result := FHttpClient.UseDefaultCredentials;
end;

procedure TNetHTTPClientHelper.SetUseDefaultCredentials(const AValue: Boolean);
begin
...
begin
  FClient.FHttpClient.CreateFormFromStings(ASource, AEncoding, AHeaders,
