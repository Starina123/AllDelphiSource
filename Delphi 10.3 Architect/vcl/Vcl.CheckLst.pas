...
procedure TCheckListBox.CMStyleChanged(var Message: TMessage);
begin
  GetCheckSizeForDPI;
  inherited;
end;

procedure TCheckListBox.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
  if isDPIChange then
    GetCheckSizeForDPI;
  inherited;
      ...
      begin
        ...
        begin
          if TStyleManager.IsCustomStyleActive then
            Canvas.Font.Color := StyleServices.GetStyleFontColor(sfEditBoxTextDisabled)
          else
  ...
  begin
    ...
    begin
      ...
      try
        ...
        StyleServices.DrawElement(Handle, ElementDetails, R, nil, FCurrentPPI);
      finally
...
procedure TCheckListBox.GetCheckSizeForDPI;
var
  DC: HDC;
  LCheckSize: TSize;
  LStyle: TCustomStyleServices;
