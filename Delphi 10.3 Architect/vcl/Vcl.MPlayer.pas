...
begin
  ...
  begin
    ...
    begin
      ...
      FillRect(R);
      if TStyleManager.IsCustomStyleActive then InflateRect(R, -1, -1);
      ...
      begin
        ...
        IsStyleButtonAvailable := StyleServices.DrawElement(Canvas.Handle,
  ...
  if not TStyleManager.IsCustomStyleActive and IsFocused then
  begin
...
var
  ...
  I: TMPBtnType;
begin
  if StyleServices.Enabled and not DoubleBuffered then
    DoubleBuffered := True;
  ...
  begin
    ...
    if StyleServices.Enabled then
    begin
      Pen.Color := StyleServices.GetSystemColor(clBtnFace);
    end
    else
      Pen.Color := clWindowFrame;
