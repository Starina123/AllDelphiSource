...
function CheckBottomAlign(AMenuItem: TMenuItem; APos: TPoint): Boolean;
var
  I: Integer;
  LMenuHeight, LWidth, LHeight: Integer;
  Buffer: TBitmap;
begin
  Result := False;
  ...
  try
    ...
    begin
      ...
      Inc(LMenuHeight, LHeight);
    end;
  finally
    Buffer.Free;
  end;
  Result := APos.Y + LMenuHeight > Screen.MonitorFromPoint(APos).WorkareaRect.Bottom;
end;
...
begin
  ...
  if CheckBottomAlign(FItems[FActiveItem].MenuItem, P) then
  begin
