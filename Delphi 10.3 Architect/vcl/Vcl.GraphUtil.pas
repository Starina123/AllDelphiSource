...
begin
  TColorRec(Result).R := Lerp(TColorRec(From).R, TColorRec(&To).R, Mu);
  TColorRec(Result).G := Lerp(TColorRec(From).G, TColorRec(&To).G, Mu);
  TColorRec(Result).B := Lerp(TColorRec(From).B, TColorRec(&To).B, Mu);
