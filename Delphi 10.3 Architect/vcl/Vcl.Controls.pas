...
begin
  ...
  if (Handle <> 0) and (TOSVersion.Major >= 10) and (TOSVersion.Build >= 14393) then
...
var
  ...
  begin
    ...
    if (Control.FOriginalParentCalcType = ctWinApi) and
...
begin
  ...
  begin
    ...
    if (LControl.Handle > 0) and GetWindowPlacement(LControl.Handle, LPlacement) then
