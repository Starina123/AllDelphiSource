...
type
  ...
  public
    constructor Create(ACanPopulate: TJSONCanPopulateProc); overload;
    constructor Create(ACanPopulate, ACanReset: TJSONCanPopulateProc); overload;
  ...
  protected
    ...
    function HasReverter(clazz: TClass; Field: string): Boolean;
...
function TJSONUnMarshal.HasReverter(clazz: TClass; Field: string): Boolean;
begin
...
function TJSONUnMarshal.Reverter(clazz: TClass; Field: string): TReverterEvent;
begin
  TMonitor.Enter(FReverters);
  try
    repeat
...
constructor TJSONPopulationCustomizer.Create(ACanPopulate, ACanReset: TJSONCanPopulateProc);
begin
  inherited Create;
