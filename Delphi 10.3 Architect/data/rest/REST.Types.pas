...
begin
  ...
  else if LContentType = CONTENTTYPE_APPLICATION_VND_EMBARCADERO_FIREDAC_JSON then
    result := ctAPPLICATION_VND_EMBARCADERO_FIREDAC_JSON
  else
...
begin
  case AContentType of
    ...
    ctAPPLICATION_VND_EMBARCADERO_FIREDAC_JSON:
      result := CONTENTTYPE_APPLICATION_VND_EMBARCADERO_FIREDAC_JSON;
  end;
end;
