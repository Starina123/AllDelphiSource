...
type
  ...
  public type
    ...
    TGetParam = procedure (ASender: TObject; const AName: string; var AValue: string) of object;
  private
  ...
  protected
    ...
    procedure DoGetParam(const AName: string; var AValue: string); virtual;
...
procedure TEMSBaseResource.DoGetParam(const AName: string; var AValue: string);
begin
  if Assigned(FOnGetParam) then
    FOnGetParam(Self, AName, AValue);
end;
