...
var
  ...
  C: Char;
begin
  Result := AMemberName.StartsWith(APrefix);
  if Result then
  begin
    S := AMemberName.Substring(Length(APrefix));
    Col := 0;
    for C in S do
    begin
      if (C >= '0') and (C <= '9') then
