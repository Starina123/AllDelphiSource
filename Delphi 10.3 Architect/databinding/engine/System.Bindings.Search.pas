...
type
  ...
  public
    ...
    class procedure EnumerateResetWrappersArguments(const StartScopeEnumerable: IScopeEnumerable; const ACallback: TProc<IArguments>);
    ...
    class procedure EnumerateReattachWrappers(const StartScopeEnumerable: IScopeEnumerable;
        const AReattachCallback: TProc<IPlaceholder>;
    const AReattachRecordCallback: TProc<IRecordPlaceholder>);
    ...
    class procedure EnumeratePrepareWrappersForEvaluation(const StartScopeEnumerable: IScopeEnumerable;
      const AResetCallback: TProc<IArguments>;
      const AReattachCallback: TProc<IPlaceholder>;
      const AReattachRecordCallback: TProc<IRecordPlaceholder>);
...
begin
  ...
  begin
    ...
    EnumeratePrepareWrappersForEvaluation(StartScopeEnumerable,
      procedure(Intf: IArguments)
      begin
        LList.Add(TPrepareArgs.Create(Intf))
      end,
      procedure(Intf: IPlaceholder)
      begin
        LList.Add(TPreparePlaceholder.Create(Intf))
      end,
      procedure(Intf: IRecordPlaceholder)
      begin
...
class procedure TBindingSearch.EnumerateResetWrappersArguments(
  const StartScopeEnumerable: IScopeEnumerable; const ACallback: TProc<IArguments>);
var
  Wrpr: IInterface;
  WrprArguments: IArguments;
  WrprScopeEnumerable: IScopeEnumerable;
