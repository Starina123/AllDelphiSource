...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAPlatformSDKAndroid, 0xFAEF0B24, 0x9E15, 0x4205, 0x99, 0x04, 0xC7, 0x96, 0xF2, 0xD9, 0xEF, 0x33);'*)
...
const
  ...
  cAndroid32ArmPlatform = PlatformConst.cAndroid32ArmPlatform;
  cAndroidPlatform      = PlatformConst.cAndroid32ArmPlatform deprecated 'use cAndroid32ArmPlatform';
...
type
  ...
  IOTAPlatform = interface(IOTAPlatform240)
    ...
    { Retruns the appropriate project display name depending of the project type }
...
type
  ...
  IOTAPlatformSDKAndroid = interface(IOTAPlatformSDKAndroid240)
    ['{FAEF0B24-9E15-4205-9904-C796F2D9EF33}']
    procedure SetGnuSTLVersion(const Value: string);
    function GetGnuSTLVersion: string;
