...
{$ENDIF}
  ...
  TOTAProcessType = (optWin32, optOSX32, optWin64, optiOS32, optAndroid, optiOS64, optLinux64, optOSX64);
...
{$ENDIF}
  ...
  IOTAIDEThemingServices = interface(IInterface)
    ...
    { Returns the selected Editor Color SpeedSetting for the IDE Theme }
    function GetEditorColorSpeedSetting(const ThemeName: string): string;
    { Returns the selected Object Inspector Color SpeedSetting for the IDE Theme }
  ...
  IOTAIDEThemingServices250 = interface(IOTAIDEThemingServices)
