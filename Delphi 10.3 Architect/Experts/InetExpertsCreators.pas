...
uses DCCStrs, ToolsApi, InetExpertsTemplateProperties, StrUtils, PlatformAPI;
...
begin
  if not (osfLinux in WebProject.PlatformTypes) then
    Exit;
  LProject := GetActiveProject;
  if LProject <> nil then
  begin
    if not (osfLinux in WebProject.ProjectPlatformTypes) then
      Exit;
