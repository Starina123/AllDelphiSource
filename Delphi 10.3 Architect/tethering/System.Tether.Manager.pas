...
function TTetheringManagerCommunicationThread.ProcessResponse(const AData: string; var RemoteConnectionString: string): string;
  ...
  begin
    Result := False;
    I := TTetheringManagerInfo.FindManagerIndex(FAdapter.Manager.RemoteManagers, ARemoteProfileId);
    if I <> -1 then
      LManagerInfo := FAdapter.Manager.RemoteManagers[I];
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            if (LPreferred = '') and (LManagerInfo.GetConnectionString(LAdaptersLocal[I]) <> EMPTYTOKEN) then
