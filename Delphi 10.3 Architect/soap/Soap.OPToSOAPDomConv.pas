...
function IsEmptyString(const ANode: IXMLNode): Boolean; inline;
begin
  Result := not ANode.hasChildNodes and (ANode.Text = '');
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        { Handle 'dateTime' }
        if IsXMLDateTimeTypeInfo(SoapTypeInfo) and (ChildNode.IsTextElement or IsEmptyString(ChildNode)) then
        begin
...
begin
  ...
  begin
    ...
    { Handle dates }
    if IsXMLDateTimeTypeInfo(Info) and (Node.IsTextElement or IsEmptyString(Node)) then
    begin
...
begin
  ...
  begin
    ...
    if SoapTypeInfo = nil then
      SoapTypeInfo := TypeInfo(System.string);
   if IsXMLDateTimeTypeInfo(SoapTypeInfo) and (Node.IsTextElement or IsEmptyString(Node)) then
   begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    end else if (ChildNode.IsTextElement or IsEmptyString(ChildNode)) then
...
begin
  Result := '';
  if (Node.IsTextElement or IsEmptyString(Node)) then
    Result := Node.Text
  else
    for I := 0 to Node.ChildNodes.Count - 1 do
